...
A vehicle station is a real-world location — a museum, park, gas station, restaurant, etc. — that the generator in [`stations-generator/`](./stations-generator/) picked from OpenStreetMap inside your play-area polygon. Each station carries:
